        ...
        _createClass(e, [
            ...
            },
            {
                ...
                value: function () {
                    ...
                    $(".menu").length &&
                        ((o = $(".menu li .collapse")),
                        $(".menu li [data-bs-toggle='collapse']").on(
                            "click",
                            function (e) {
                                return !1;
                            }
                                ...
                                this.href == r &&
                                    ...
                                    (o =
                                        ...
                                        $(this)
                                            ...
                                            .attr("id")),
                                    $("#two-col-sidenav-main .menu-link").each(
                                        function () {
                                            $(this).attr("href") === o &&
                                                (a = $(this));
                                        }
            ...
            },
            {
                ...
                value: function (e, t) {
                    for (; e; ) {
                        if (
                            e.parentElement &&
                            e.parentElement.querySelector(t) === e
                        )
                            return e;
                        e = e.parentElement;
                    }
            ...
            },
            {
                ...
                value: function () {
                    (this.config = JSON.parse(
                        ...
                        this.changeTwocolumnColor(
                            this.config.sidenav.twocolumn
                        ),
                        this.adjustLayout();
                },
            },
            {
                ...
                value: function () {
                    ...
                    document
                        ...
                        document
                            .querySelectorAll(
                                "input[name=data-two-column-color]"
                            )
                            .forEach(function (t) {
                                t.addEventListener("change", function (e) {
